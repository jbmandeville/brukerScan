...
void MainWindow::alignEPIToReslicedAnatomy(int exitCode, QProcess::ExitStatus exitStatus)
{
    ...
    QString anatomyName = "anatomy/" + _anatomyDirBox->currentText() + "/resliceBrain.nii";
    QString templateFileName = "./epi/" + _fMRITemplateDirBox->currentText() + "/mcTemplateRaw.nii";
    QStringList arguments;
    arguments.append(templateFileName);
    arguments.append("-a");
...
void MainWindow::finishedGenerateBrukerNiftiFunctional(int exitCode, QProcess::ExitStatus exitStatus )
{
    qInfo() << "finished: alignment";
    qInfo() << "exit code" << exitCode << "exit status" << exitStatus;
    updateEPIFileNameBox("raw.nii");
    enableEPIActionButtons();
    finishedProcess();
}
...
void MainWindow::alignEPI()
{
    ...
    bool alignAnatomyComExists = anatomyFileExists("align.com");
    ...
    QString individualAnatomy = "anatomy/" + _anatomyDirBox->currentText() + "/align.nii";
